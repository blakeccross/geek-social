  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-between p-10">
      <div className="z-10 flex w-full max-w-5xl items-center justify-center  lg:justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-tfrom-zinc-800 via-zinc-800 lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a
          ...
          >
            Sponsored By <Image key={1} src={logo} alt="Ronin Logo" className="invert" width={100} height={24} priority />
          </a>
        </div>
      </div>
        ...
        <div className="py-8 px-4 mx-auto max-w-5xl  lg:py-16">
          <div className="items-center mb-8 lg:mb-24 lg:gap-12 lg:grid-cols-12">
            <div className="col-span-6 text-center sm:mb-6 lg:text-left lg:mb-0">
              <h1 className="mb-4 text-6xl text-center font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white font-display">
                Find Your People_
              </h1>
              <p className={"max-w-4xl mb-6 text-center lg:mx-0 xl:mb-8 md:text-lg xl:text-xl text-gray-400"}>
...
<div class="mc-field-group"><input type="email" name="EMAIL" class="block p-3 pl-10 w-full text-sm rounded-lg border  sm:w-80 xl:w-96 focus:ring-primary-500 focus:border-primary-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" id="mce-EMAIL" required="" value=""><span id="mce-EMAIL-HELPERTEXT" class="helper_text"></span></div>
...
<script type="text/javascript" src="//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js"></script><script type="text/javascript">(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[3]='ADDRESS';ftypes[3]='address';fnames[4]='PHONE';ftypes[4]='phone';fnames[5]='BIRTHDAY';ftypes[5]='birthday';fnames[6]='MMERGE6';ftypes[6]='text';}(jQuery));var $mcj = jQuery.noConflict(true);</script></div>`,
      ...
      <section>
        <div className="max-w-5xl py-8 lg:px-6 lg:py-24">
          <div className="text-center">
            <h2 className="text-5xl font-extrabold leading-tight tracking-tight sm:text-5xl text-white">Two simple rules</h2>
          </div>

          <div className="p-5 mx-auto mt-8 space-y-5 border rounded-lg  bg-gray-800 border-gray-700">
            <div className="pb-5 border-b  border-gray-700">
              <h3 className="text-xl font-semibold text-white">Rule 1</h3>
            ...
            <div className="pb-5 border-b border-gray-700">
              <h3 className="text-xl font-semibold text-white">Rule 2</h3>
              <p className="mt-1 text-base font-normal text-gray-400">
      ...
      {/* <section className="max-w-5xl  antialiased">
        <div className=" px-4 py-8 lg:px-6 sm:py-16 lg:py-24">
          <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16 lg:flex-row lg:items-start">
            <div>
              <h2 className="text-3xl font-extrabold leading-tight tracking-tight sm:text-4xl text-white">Meet A Geek_</h2>
      ...
      <section>
        <div className="max-w-5xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-5xl font-extrabold leading-tight tracking-tight sm:text-4xl text-white">Upcoming Events</h2>
          ...
          <div className="flex justify-center gap-4 mt-8 xl:gap-12">
            <div className="p-5 space-y-4 border  rounded-lg shadow-md lg:p-8 bg-gray-800 border-gray-700 max-w-xl">
              <img
              ...
              />
              <div className="m-t-4">
                <span className="text-lg font-bold leading-tight text-white">August Geek Social </span>
              </div>
              ...
              <p className="text-base font-normal text-gray-400">Geeky munchies provided by Rōnin Consulting Drink specials until 8 pm.</p>
      ...
      <footer className=" rounded-lg shadow m-4 bg-gray-800">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          <span className="text-smsm:text-center text-gray-400">Made with love by Ronin ❤️</span>
        </div>
      </footer>
    </main>
  );
